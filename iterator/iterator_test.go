...
func TestDataIteratorEmbeddedStruct(t *testing.T) {
  ...
  testAssertEqual(t, "F0", val.Interface())
  ...
  testAssertEqual(t, "F1", val.Interface())
  ...
  testAssertEqual(t, "F2", val.Interface())
...
func TestDataIteratorStruct(t *testing.T) {
  ...
  testAssertEqual(t, reflect.TypeOf(&address{}), reflect.TypeOf(val.Interface()))
  ...
  testAssertEqual(t, 30, val.Interface())
  ...
  testAssertEqual(t, "Bob", val.Interface())
...
func TestDataIteratorMap(t *testing.T) {
  ...
  testAssertEqual(t, "address", val.Name())
  testAssertEqual(t, "address", val.Key())
  testAssertEqual(t, reflect.TypeOf(map[string]interface{}{}), reflect.TypeOf(val.Interface()))
  ...
  testAssertEqual(t, "iloveu", val.Interface())
  ...
  testAssertEqual(t, reflect.TypeOf([]string{}), reflect.TypeOf(val.Interface()))
...
func TestDataIteratorSlice(t *testing.T) {
  ...
  testAssertEqual(t, reflect.TypeOf([]interface{}{}), reflect.TypeOf(val.Interface()))
}
